package com.example.newsdeliveryapp.classifier;
...
public class ArticleClassifier {
    ...
    public String classifyArticle(Article article) {
        String prompt = "Classify this news article based on whether they are 'local' or 'global and assign a category to each of the articles.'\n" +
                ...
                " - To categorize an article you can use only one of these categories: News, Sport, Health, Food, Lifestyle, Science, Business, Entertainment, Other\n" +
